...
public class DecodeCusHandler extends Handler {

    private static final String TAG = DecodeCusHandler.class.getSimpleName();

    private final CaptureCusFragment fragment;
    private final MultiFormatReader multiFormatReader;

    DecodeCusHandler(CaptureCusFragment fragment, Hashtable<DecodeHintType, Object> hints) {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            bundle.putParcelable(DecodeCusThread.BARCODE_BITMAP, source.renderCroppedGreyscaleBitmap());
